...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] >> 7) & 0x01])) << 48;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 63) & 0x01];
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] >> 4) & 0x0f])) << 48;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 60) & 0x0f];
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[UNIT_PTR(x)[0] & 0xff])) << 48;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 56) & 0xff];
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] >> 7) & 0x01])) << 16;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 31) & 0x01];
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] >> 4) & 0x0f])) << 16;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 28) & 0x0f];
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[UNIT_PTR(x)[0] & 0xff])) << 16;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 24) & 0xff];
#endif
...
gf_decl void gf_mulx1_bl(gf_t r, const gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[0] >> 7) & 0x01];
...
gf_decl void gf_mulx4_bl(gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[0] >> 4) & 0x0f];
...
gf_decl void gf_mulx8_bl(gf_t x)
{   uint_16t _tt = gf_tab[UNIT_PTR(x)[0]];
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    (( gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] << 7) & 0x80])) << 48;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 49) & 0x80];
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] << 4) & 0xf0])) << 48;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 52) & 0xf0];
#endif
...
{   gf_unit_t _tt = 
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] << 7) & 0x80])) << 16;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 17) & 0x80];
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[0] << 4) & 0xf0])) << 16;
#else
    gf_tab[(UNIT_PTR(x)[0] >> 20) & 0xf0];
#endif
...
gf_decl void gf_mulx1_bb(gf_t r, const gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[0] << 7) & 0x80];
...
gf_decl void gf_mulx4_bb(gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[0] << 4) & 0xf0];
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[1] >> 63) & 0x01];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[1] >> 7) & 0x01])) << 48;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[1] >> 60) & 0x0f];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[1] >> 4) & 0x0f])) << 48;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[UNIT_PTR(x)[1] >> 56];
#else
    ((gf_unit_t)(gf_tab[UNIT_PTR(x)[1] & 0xff])) << 48;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[3] >> 31) & 0x01];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[3] >> 7) & 0x01])) << 16;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[3] >> 28) & 0x0f];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[3] >> 4) & 0x0f])) << 16;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[UNIT_PTR(x)[3] >> 24];
#else
    ((gf_unit_t)(gf_tab[UNIT_PTR(x)[3] & 0xff])) << 16;
#endif
...
gf_decl void gf_mulx1_ll(gf_t r, const gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[15] >> 7) & 0x01];
...
gf_decl void gf_mulx4_ll(gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[15] >> 4) & 0x0f];
...
gf_decl void gf_mulx8_ll(gf_t x)
{   uint_16t _tt = gf_tab[UNIT_PTR(x)[15]];
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[1] >> 49) & MASK(0x80)];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[1] << 7) & 0xff])) << 48;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[1] >> 52) & MASK(0xf0)];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[1] << 4) & 0xff])) << 48;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[3] >> 17) & MASK(0x80)];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[3] << 7) & 0xff])) << 16;
#endif
...
{   gf_unit_t _tt =
#if PLATFORM_BYTE_ORDER == IS_LITTLE_ENDIAN
    gf_tab[(UNIT_PTR(x)[3] >> 20) & MASK(0xf0)];
#else
    ((gf_unit_t)(gf_tab[(UNIT_PTR(x)[3] << 4) & 0xff])) << 16;
#endif
...
gf_decl void gf_mulx1_lb(gf_t r, const gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[15] << 7) & 0x80];
...
gf_decl void gf_mulx4_lb(gf_t x)
{   uint_16t _tt = gf_tab[(UNIT_PTR(x)[15] << 4) & 0xf0];
